...
|:-----------------------|-------------:|---------------:|--------------------:|---------------:|-----------:|--------------:|
| BuyAndHoldStrategy     |        22.89 |           0.53 |              -32.93 |         nan    |          0 |          0.02 |
| RSI2PeriodStrategy     |         3.08 |           0.11 |              -20.82 |          51.85 |         27 |          0.06 |
...
| RSI2PeriodStrategy     |        27.06 |           0.45 |              -33.83 |          68.97 |         29 |          0.06 |
| BuyAndHoldStrategy     |        34.31 |           0.36 |              -54.25 |         nan    |          0 |          0.02 |
| BollingerBandsStrategy |       -11.69 |          -0.88 |              -11.85 |          36.36 |         11 |          0.05 |
...
| Strategy               |   Return [%] |   Sharpe Ratio |   Max. Drawdown [%] |   Win Rate [%] |   # Trades |   Runtime [s] |
|:-----------------------|-------------:|---------------:|--------------------:|---------------:|-----------:|--------------:|
| RSI2PeriodStrategy     |        32.71 |           0.84 |              -12.37 |          69.23 |         26 |          0.07 |
| BuyAndHoldStrategy     |        23.34 |           0.48 |              -30.61 |         nan    |          0 |          0.02 |
| SimpleMACrossover      |        -0.78 |          -0.03 |              -17.7  |          50    |          6 |          0.04 |
| BollingerBandsStrategy |        -6.13 |          -0.73 |               -8.42 |          25    |          4 |          0.05 |
...
| Strategy               |   Return [%] |   Sharpe Ratio |   Max. Drawdown [%] |   Win Rate [%] |   # Trades |   Runtime [s] |
|:-----------------------|-------------:|---------------:|--------------------:|---------------:|-----------:|--------------:|
| RSI2PeriodStrategy     |        44.55 |           0.64 |              -26.34 |          70.59 |         34 |          0.07 |
| BollingerBandsStrategy |        13.58 |           0.56 |               -5.59 |          50    |          6 |          0.05 |
...
| Strategy               |   Return [%] |   Sharpe Ratio |   Max. Drawdown [%] |   Win Rate [%] |   # Trades |   Runtime [s] |
|:-----------------------|-------------:|---------------:|--------------------:|---------------:|-----------:|--------------:|
| SimpleMACrossover      |        20.95 |           1.14 |               -7.17 |          71.43 |          7 |          0.04 |
| RSI2PeriodStrategy     |         9.14 |           0.66 |               -9.89 |          50    |         36 |          0.07 |
...
| SimpleMACrossover      |        11.46 |           0.57 |              -16.38 |          37.5  |          8 |          0.04 |
| BuyAndHoldStrategy     |        14.46 |           0.46 |              -21.69 |         nan    |          0 |          0.02 |
...
| BollingerBandsStrategy |        -4.31 |          -0.35 |              -13.71 |          66.67 |          6 |          0.05 |
...
| Strategy               |   Return [%] |   Sharpe Ratio |   Max. Drawdown [%] |   Win Rate [%] |   # Trades |   Runtime [s] |
|:-----------------------|-------------:|---------------:|--------------------:|---------------:|-----------:|--------------:|
| RSI2PeriodStrategy     |        -2.45 |          -0.13 |              -16.75 |          53.33 |         30 |          0.06 |
| BuyAndHoldStrategy     |       -10    |          -0.44 |              -25.48 |         nan    |          0 |          0.02 |
| BollingerBandsStrategy |        -2.65 |          -0.55 |               -3.64 |          45.45 |         11 |          0.05 |
...
| BuyAndHoldStrategy     |        18.39 |           0.76 |              -17.94 |         nan    |          0 |          0.02 |
| SimpleMACrossover      |         0.64 |           0.05 |              -17.51 |          20    |          5 |          0.05 |
| BollingerBandsStrategy |        -6.61 |          -1.2  |               -8.66 |          20    |         10 |          0.05 |
...
| RSI2PeriodStrategy     |        19.75 |           0.26 |              -42.78 |          68.97 |         29 |          0.07 |
